...
function preload(){
  happysky = loadImage('images/happysky.jpg');
    ...
    // happysound = loadSound ('angry sound.mp3');
    // sadsound = loadSound ('sad sound.mp3');
    // neutralsound = loadSound('neutral sound.mp3');
    // angrysound = loadSound('angry sound.mp3');
    // disgustedsound = loadSound('disgusted sound.mp3');
